const faq = [
  {
    ...
    answer:
      'To create a new season, you need to go to the [Seasons Page](/admin/seasons) page, check the current seasons times and click on the **Create New Season** button to create a new one.',
  },
  {
