...
const CellItem = styled.div<{ coordinates: DonationGuideCoordinate; type: string }>`
  ...
  @media only screen and (max-width: 480px) {
    ${props => props.coordinates.mobile.hidden && `display: none;`}
  ...
  @media only screen and (min-width: 480px) and (max-width: 780px) {
    ${props => props.coordinates.phablet.hidden && `display: none;`}
  ...
  @media only screen and (min-width: ${breakpoint.tablet}px) and (max-width: ${breakpoint.laptop - 1}px) {
    ${props => props.coordinates.tablet.hidden && `display: none;`}
  ...
  @media only screen and (min-width: ${breakpoint.laptop}px) and (max-width: 1719px) {
    ${props => props.coordinates.laptop.hidden && `display: none;`}
  ...
  @media only screen and (min-width: 1720px) {
    ${props => props.coordinates.desktop.hidden && `display: none;`}
