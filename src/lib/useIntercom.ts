...
import { loadIntercom, trackEvent as trackEventLib, shutdownIntercom } from 'next-intercom'
...
export function useIntercom() {
  ...
  const trackEvent = (type: intercomEventEnum, target: object = {}) => trackEventLib(type, target)

  return { startIntercom, trackEvent }
}
